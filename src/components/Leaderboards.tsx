                                                      ...
                                                      <td className="px-3 md:px-8 py-2.5 md:py-4">
                                                          <div className="flex items-center gap-2 md:gap-3">
                                                              ...
                                                              <div className="min-w-0">
                                                                  <p className="text-xs md:text-sm font-bold text-text-app group-hover:text-brand-primary transition-colors truncate max-w-20 sm:max-w-37.5 md:max-w-none">
                                                                      {
                                                                          user.handle
                                                                      }
                                                                  </p>
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex-1 min-w-0 pr-4">
                                                <h4 className="text-xs font-bold text-text-app truncate group-hover:text-brand-primary transition-colors">
                                                    {contest.name}
                                                </h4>
